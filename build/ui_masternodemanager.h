...
public:
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "Advantage Node Count:", nullptr));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Advantage Network", nullptr));
