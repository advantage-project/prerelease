...
public:
    ...
    void setupUi(QDialog *SendMessagesDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 299));
        ...
        pushButton = new QPushButton(SendMessagesDialog);
    ...
    void retranslateUi(QDialog *SendMessagesDialog)
    {
        ...
        pushButton->setText(QApplication::translate("SendMessagesDialog", "Join Discord", nullptr));
#ifndef QT_NO_TOOLTIP
