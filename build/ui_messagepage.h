...
public:
    ...
    void setupUi(QWidget *MessagePage)
    {
        ...
        pushButton = new QPushButton(MessagePage);
        pushButton->setObjectName(QStringLiteral("pushButton"));

        horizontalLayout->addWidget(pushButton);

        pushButton_2 = new QPushButton(MessagePage);
    ...
    void retranslateUi(QWidget *MessagePage)
    {
        ...
        pushButton->setText(QApplication::translate("MessagePage", "Join Discord", nullptr));
        pushButton_2->setText(QApplication::translate("MessagePage", "Join Telegram", nullptr));
    } // retranslateUi
