...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04dab9c95dc5416b67b17af1ceb0caa9642d864db8963db330b0cc8c30d8a397c93e743d56d35080719f30e9a6629d88f948e130d320358b0ac6604c71f7109043");
        nDefaultPort = 11235;
        nRPCPort = 53211;
        bnProofOfWorkLimit = CBigNum(~uint256(0) >> 16);
		treasuryAddress = "AGms6YvsAUbtjRtreSaYYymi9DheDVKRUi"; //update accordingly
	...
	vSeeds.push_back(CDNSSeedData("1", "ec2-18-191-195-190.us-east-2.compute.amazonaws.com"));
        vSeeds.push_back(CDNSSeedData("18.191.195.190", "18.191.195.190"));
        vSeeds.push_back(CDNSSeedData("172.31.14.140", "172.31.14.140"));
        vSeeds.push_back(CDNSSeedData("71.17.229.82", "71.17.229.82"));//update permanent seednode

        nPoolMaxTransactions = 3;

        strDarksendPoolDummyAddress = "AHhWC9PRgMzm6z5Xx3zjCSTG5zJ5u71UbL"; //irrelevant
        nLastPOWBlock = 10; //update accordingly
        nPOSStartBlock = 2;
    }
